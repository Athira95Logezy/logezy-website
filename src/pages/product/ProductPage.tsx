...
function SchedulingMockup() {
  ...
  const cols = [['#EEF2FF','#5B6CF9'],['#F5F3FF','#7C3AED'],['#DBEAFE','#2563EB'],['#ECFEFF','#0891B2']];
  return (
    <BrowserChrome>
      <div style={{ background: 'white', padding: 16 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
          <span style={{ fontSize: 12, fontWeight: 700, color: NAVY }}>Week 20 Rota</span>
          <span style={{ fontSize: 9, background: '#EEF2FF', color: INDIGO, fontWeight: 700, padding: '2px 8px', borderRadius: 20 }}>Auto-generated</span>
        </div>
      ...
      <div style={{ background: '#F8FAFC', padding: 14, display: 'flex', flexDirection: 'column', gap: 8 }}>
        <div style={{ background: 'white', borderRadius: 10, padding: 12, border: '1px solid #E5E7EB' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
            <div style={{ width: 32, height: 32, borderRadius: '50%', background: 'linear-gradient(135deg,#5B6CF9,#8B5CF6)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: 11, fontWeight: 700 }}>SM</div>
            <div style={{ flex: 1 }}>
      ...
      <div style={{ background: 'white', padding: 16 }}>
        ...
        {[
          ...
          <div key={t.name} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '8px 0', borderBottom: '1px solid #F3F4F6' }}>
            ...
            <div style={{ fontSize: 8, background: t.signed ? '#EEF2FF' : '#F3F4F6', color: t.signed ? INDIGO : '#9CA3AF', padding: '4px 10px', borderRadius: 6, fontWeight: 700 }}>
...
function MobileAppMockup() {
  return (
    <PhoneChrome>
      <div style={{ background: 'linear-gradient(160deg,#0C1835,#0E2050)', padding: '16px 14px', minHeight: 290 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
          ...
          <div style={{ width: 32, height: 32, borderRadius: '50%', background: 'linear-gradient(135deg,#5B6CF9,#8B5CF6)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: 12, fontWeight: 700 }}>S</div>
        </div>
        {[
        ...
        <div style={{ display: 'flex', justifyContent: 'space-around', marginTop: 12, paddingTop: 10, borderTop: '1px solid rgba(255,255,255,0.08)' }}>
          {['Shifts','Availability','Timesheets','Chat'].map(tab => (
            <div key={tab} style={{ fontSize: 8, color: tab === 'Shifts' ? '#5B6CF9' : 'rgba(255,255,255,0.35)', fontWeight: tab === 'Shifts' ? 700 : 400, textAlign: 'center' }}>{tab}</div>
          ))}
        </div>
      </div>
    </PhoneChrome>
      ...
      <div style={{ background: 'white', padding: 16 }}>
        ...
        {steps.map(s => (
          <div key={s.n} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '7px 0', borderBottom: '1px solid #F3F4F6' }}>
            <div style={{ width: 22, height: 22, borderRadius: '50%', background: s.s === 'done' ? '#DCFCE7' : s.s === 'active' ? '#EEF2FF' : '#F3F4F6', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
...
const pages: PageConfig[] = [
  {
    ...
    accent: '#5B6CF9',
    accentBg: '#EEF2FF',
    heroBg: 'linear-gradient(135deg,#EEF2FF 0%,#F5F3FF 60%,#FFFFFF 100%)',
    title: 'Scheduling',
  ...
  },
  {
    ...
    accent: '#5B6CF9',
    accentBg: '#EEF2FF',
    heroBg: 'linear-gradient(135deg,#EEF2FF 0%,#ECFEFF 60%,#FFFFFF 100%)',
    title: 'Availability',
  ...
  },
  {
    ...
    accent: '#0891B2',
    accentBg: '#ECFEFF',
    heroBg: 'linear-gradient(135deg,#ECFEFF 0%,#EEF2FF 60%,#FFFFFF 100%)',
